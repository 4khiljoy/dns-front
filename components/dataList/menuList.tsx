...
// 	}, [])
// 	return (
// 		<div className="min-h-screen w-full bg-[url('/bge.jpeg')] bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center">
// 		<div className='flex flex-col gap-4 p-5 border-2 shadow-lg m-5 rounded-2xl border-white text-white'>
// 			<p className='text-2xl font-bold uppercase text-white items-center'>menuList</p>
// 			{data.map((item: Item) => {
// 				return (
// 					<div
// 						key={item.id}
